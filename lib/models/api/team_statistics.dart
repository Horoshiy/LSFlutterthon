...
class CurrentSeason {
  ...
  factory CurrentSeason.fromJson(Map<String, dynamic> json) => _$CurrentSeasonFromJson(json);
...
class TeamSeasonCoverage {
  ...
  factory TeamSeasonCoverage.fromJson(Map<String, dynamic> json) => _$TeamSeasonCoverageFromJson(json);
...
class GoalAttempts {
  ...
  factory GoalAttempts.fromJson(Map<String, dynamic> json) => _$GoalAttemptsFromJson(json);
...
class GoaltimeStatistics {
  ...
  factory GoaltimeStatistics.fromJson(Map<String, dynamic> json) => _$GoaltimeStatisticsFromJson(json);
