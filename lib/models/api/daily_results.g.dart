...
SportEventStatus _$SportEventStatusFromJson(Map<String, dynamic> json) {
  return SportEventStatus(
    ...
    periodScores: (json['period_scores'] as List)
      ...
      ? null
      : SportEventClock.fromJson(json['clock'] as Map<String, dynamic>);
}
...
SportEventClock _$SportEventClockFromJson(Map<String, dynamic> json) {
  return SportEventClock(
    matchTime: json['match_time'] as String,
  );
}

Map<String, dynamic> _$SportEventClockToJson(SportEventClock instance) =>
    <String, dynamic>{
